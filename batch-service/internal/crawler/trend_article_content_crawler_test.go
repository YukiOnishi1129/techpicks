...
func Test_Crawler_TrendArticleContentsCrawler(t *testing.T) {
	...
	// 3. article 1, trend 1, far 1, trend.updateAt > 6 hour ago and trend.count < arg.count, update trend, not article, far

	// 4. article 1, trend 1, far 1, trend.updateAt < 6 hour ago and trend.count < arg.count, not update trend, not article, far

	// 5. article 1, trend 1, far 1, trend.updateAt > 6 hour ago and trend.count > arg.count, not update trend, not article, far
