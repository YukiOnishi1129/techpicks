...
func (r *platformR) GetBookmarks() BookmarkSlice {
	if r == nil {
		return nil
	}
	return r.Bookmarks
...
func (r *platformR) GetFavoriteArticles() FavoriteArticleSlice {
	if r == nil {
		return nil
	}
...
func (o *Platform) Bookmarks(mods ...qm.QueryMod) bookmarkQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"bookmarks\".\"platform_id\"=?", o.ID),
	)
...
func (o *Platform) FavoriteArticles(mods ...qm.QueryMod) favoriteArticleQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"favorite_articles\".\"platform_id\"=?", o.ID),
	)
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (platformL) LoadBookmarks(ctx context.Context, e boil.ContextExecutor, singular bool, maybePlatform interface{}, mods queries.Applicator) error {
	var slice []*Platform
	var object *Platform
	...
	query := NewQuery(
		qm.From(`bookmarks`),
		qm.WhereIn(`bookmarks.platform_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (platformL) LoadFavoriteArticles(ctx context.Context, e boil.ContextExecutor, singular bool, maybePlatform interface{}, mods queries.Applicator) error {
	var slice []*Platform
	var object *Platform
	...
	query := NewQuery(
		...
		qm.WhereIn(`favorite_articles.platform_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets related.R.Platform appropriately.
func (o *Platform) AddBookmarks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Bookmark) error {
	var err error
	for _, rel := range related {
		if insert {
...
// Sets o.R.Platform's Bookmarks accordingly.
// Replaces o.R.Bookmarks with related.
// Sets related.R.Platform's Bookmarks accordingly.
func (o *Platform) SetBookmarks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Bookmark) error {
	query := "update \"bookmarks\" set \"platform_id\" = null where \"platform_id\" = $1"
...
func (o *Platform) RemoveBookmarks(ctx context.Context, exec boil.ContextExecutor, related ...*Bookmark) error {
	if len(related) == 0 {
		return nil
	}
...
// Sets related.R.Platform appropriately.
func (o *Platform) AddFavoriteArticles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*FavoriteArticle) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.PlatformID, o.ID)
...
// platform replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Platform's FavoriteArticles accordingly.
// Replaces o.R.FavoriteArticles with related.
// Sets related.R.Platform's FavoriteArticles accordingly.
func (o *Platform) SetFavoriteArticles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*FavoriteArticle) error {
	query := "update \"favorite_articles\" set \"platform_id\" = null where \"platform_id\" = $1"
	values := []interface{}{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
...
// Sets related.R.Platform.
func (o *Platform) RemoveFavoriteArticles(ctx context.Context, exec boil.ContextExecutor, related ...*FavoriteArticle) error {
	if len(related) == 0 {
		return nil
	}
