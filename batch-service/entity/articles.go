...
type articleR struct {
	...
	ArticleComments      ArticleCommentSlice      `boil:"ArticleComments" json:"ArticleComments" toml:"ArticleComments" yaml:"ArticleComments"`
...
func (r *articleR) GetArticleComments() ArticleCommentSlice {
	if r == nil {
		return nil
	}
	return r.ArticleComments
}
...
func (r *articleR) GetFavoriteArticles() FavoriteArticleSlice {
	if r == nil {
		return nil
	}
...
// ArticleComments retrieves all the article_comment's ArticleComments with an executor.
func (o *Article) ArticleComments(mods ...qm.QueryMod) articleCommentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"article_comments\".\"article_id\"=?", o.ID),
	)
...
func (o *Article) FavoriteArticles(mods ...qm.QueryMod) favoriteArticleQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"favorite_articles\".\"article_id\"=?", o.ID),
	)
...
func (o *Article) FeedArticleRelations(mods ...qm.QueryMod) feedArticleRelationQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"feed_article_relations\".\"article_id\"=?", o.ID),
	)
...
// LoadArticleComments allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (articleL) LoadArticleComments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeArticle interface{}, mods queries.Applicator) error {
	var slice []*Article
	var object *Article
	...
	query := NewQuery(
		...
		qm.WhereIn(`article_comments.article_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.ArticleComments = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.ArticleID {
				local.R.ArticleComments = append(local.R.ArticleComments, foreign)
				if foreign.R == nil {
					foreign.R = &articleCommentR{}
				}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (articleL) LoadFavoriteArticles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeArticle interface{}, mods queries.Applicator) error {
	var slice []*Article
	var object *Article
	...
	query := NewQuery(
		...
		qm.WhereIn(`favorite_articles.article_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (articleL) LoadFeedArticleRelations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeArticle interface{}, mods queries.Applicator) error {
	var slice []*Article
	var object *Article
	...
	query := NewQuery(
		...
		qm.WhereIn(`feed_article_relations.article_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// AddArticleComments adds the given related objects to the existing relationships
// of the article, optionally inserting them as new records.
// Appends related to o.R.ArticleComments.
// Sets related.R.Article appropriately.
func (o *Article) AddArticleComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ArticleComment) error {
	var err error
	...
	if o.R == nil {
		o.R = &articleR{
			ArticleComments: related,
		}
	} else {
		o.R.ArticleComments = append(o.R.ArticleComments, related...)
	}
...
// Sets related.R.Article appropriately.
func (o *Article) AddFavoriteArticles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*FavoriteArticle) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ArticleID = o.ID
...
// Sets related.R.Article appropriately.
func (o *Article) AddFeedArticleRelations(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*FeedArticleRelation) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ArticleID = o.ID
