...
type Account struct {
	...
	ProviderAccountID string      `boil:"provider_account_id" json:"provider_account_id" toml:"provider_account_id" yaml:"provider_account_id"`
	...
	OauthTokenSecret  null.String `boil:"oauth_token_secret" json:"oauth_token_secret,omitempty" toml:"oauth_token_secret" yaml:"oauth_token_secret,omitempty"`
	OauthToken        null.String `boil:"oauth_token" json:"oauth_token,omitempty" toml:"oauth_token" yaml:"oauth_token,omitempty"`
...
var AccountTableColumns = struct {
	...
	ProviderAccountID: "accounts.provider_account_id",
	...
	OauthTokenSecret:  "accounts.oauth_token_secret",
	OauthToken:        "accounts.oauth_token",
...
var AccountWhere = struct {
	...
	OauthTokenSecret  whereHelpernull_String
	OauthToken        whereHelpernull_String
	CreatedAt         whereHelpertime_Time
	UpdatedAt         whereHelpertime_Time
}{
	ID:                whereHelperstring{field: "\"accounts\".\"id\""},
	UserID:            whereHelperstring{field: "\"accounts\".\"user_id\""},
	Type:              whereHelperstring{field: "\"accounts\".\"type\""},
	Provider:          whereHelperstring{field: "\"accounts\".\"provider\""},
	ProviderAccountID: whereHelperstring{field: "\"accounts\".\"provider_account_id\""},
	RefreshToken:      whereHelpernull_String{field: "\"accounts\".\"refresh_token\""},
	AccessToken:       whereHelpernull_String{field: "\"accounts\".\"access_token\""},
	ExpiresAt:         whereHelpernull_Int{field: "\"accounts\".\"expires_at\""},
	TokenType:         whereHelpernull_String{field: "\"accounts\".\"token_type\""},
	Scope:             whereHelpernull_String{field: "\"accounts\".\"scope\""},
	IDToken:           whereHelpernull_String{field: "\"accounts\".\"id_token\""},
	SessionState:      whereHelpernull_String{field: "\"accounts\".\"session_state\""},
	OauthTokenSecret:  whereHelpernull_String{field: "\"accounts\".\"oauth_token_secret\""},
	OauthToken:        whereHelpernull_String{field: "\"accounts\".\"oauth_token\""},
...
var (
	accountAllColumns            = []string{"id", "user_id", "type", "provider", "provider_account_id", "refresh_token", "access_token", "expires_at", "token_type", "scope", "id_token", "session_state", "oauth_token_secret", "oauth_token", "created_at", "updated_at"}
	accountColumnsWithoutDefault = []string{"id", "user_id", "type", "provider", "provider_account_id", "updated_at"}
	accountColumnsWithDefault    = []string{"refresh_token", "access_token", "expires_at", "token_type", "scope", "id_token", "session_state", "oauth_token_secret", "oauth_token", "created_at"}
