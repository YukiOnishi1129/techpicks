...
var ProfileTableColumns = struct {
	...
	EmailVerifiedAt: "profiles.email_verified_at",
	Image:           "profiles.image",
	Provider:        "profiles.provider",
	IsSuperAdmin:    "profiles.is_super_admin",
...
var ProfileWhere = struct {
	...
	Email:           whereHelperstring{field: "\"profiles\".\"email\""},
	EmailVerifiedAt: whereHelpernull_Time{field: "\"profiles\".\"email_verified_at\""},
	Image:           whereHelperstring{field: "\"profiles\".\"image\""},
	Provider:        whereHelpernull_String{field: "\"profiles\".\"provider\""},
	IsSuperAdmin:    whereHelperbool{field: "\"profiles\".\"is_super_admin\""},
...
type profileR struct {
	UserArticleComments        ArticleCommentSlice        `boil:"UserArticleComments" json:"UserArticleComments" toml:"UserArticleComments" yaml:"UserArticleComments"`
...
func (r *profileR) GetUserArticleComments() ArticleCommentSlice {
	if r == nil {
		return nil
	}
	return r.UserArticleComments
}

func (r *profileR) GetUserBookmarks() BookmarkSlice {
	if r == nil {
		return nil
	}
...
var (
	profileAllColumns            = []string{"id", "name", "email", "email_verified_at", "image", "provider", "is_super_admin", "created_at", "updated_at", "deleted_at"}
	profileColumnsWithoutDefault = []string{"id", "name", "email", "image"}
	profileColumnsWithDefault    = []string{"email_verified_at", "provider", "is_super_admin", "created_at", "updated_at", "deleted_at"}
...
func (q profileQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Profile, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: failed to execute a one query for profiles")
	}
...
func (q profileQuery) All(ctx context.Context, exec boil.ContextExecutor) (ProfileSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "entity: failed to assign all query results to Profile slice")
	}
...
func (q profileQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to count profiles rows")
	}
...
func (q profileQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "entity: failed to check if profiles exists")
	}

	return count > 0, nil
}

// UserArticleComments retrieves all the article_comment's ArticleComments with an executor via user_id column.
func (o *Profile) UserArticleComments(mods ...qm.QueryMod) articleCommentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"article_comments\".\"user_id\"=?", o.ID),
	)

	return ArticleComments(queryMods...)
}

// UserBookmarks retrieves all the bookmark's Bookmarks with an executor via user_id column.
func (o *Profile) UserBookmarks(mods ...qm.QueryMod) bookmarkQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
...
func (o *Profile) UserMyFeeds(mods ...qm.QueryMod) myFeedQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"my_feeds\".\"user_id\"=?", o.ID),
	)

	return MyFeeds(queryMods...)
}

// LoadUserArticleComments allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (profileL) LoadUserArticleComments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProfile interface{}, mods queries.Applicator) error {
	var slice []*Profile
	var object *Profile
	...
	query := NewQuery(
		qm.From(`article_comments`),
		qm.WhereIn(`article_comments.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load article_comments")
	}

	var resultSlice []*ArticleComment
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice article_comments")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on article_comments")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for article_comments")
	}
	...
	if singular {
		object.R.UserArticleComments = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &articleCommentR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.UserID {
				local.R.UserArticleComments = append(local.R.UserArticleComments, foreign)
				if foreign.R == nil {
					foreign.R = &articleCommentR{}
				}
...
// LoadUserBookmarks allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (profileL) LoadUserBookmarks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProfile interface{}, mods queries.Applicator) error {
	var slice []*Profile
	var object *Profile
	...
	query := NewQuery(
		qm.From(`bookmarks`),
		qm.WhereIn(`bookmarks.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.UserBookmarks = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &bookmarkR{}
			}
...
// LoadUserMyFeeds allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (profileL) LoadUserMyFeeds(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProfile interface{}, mods queries.Applicator) error {
	var slice []*Profile
	var object *Profile
	...
	query := NewQuery(
		qm.From(`my_feeds`),
		qm.WhereIn(`my_feeds.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.UserMyFeeds = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &myFeedR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.UserID {
				local.R.UserMyFeeds = append(local.R.UserMyFeeds, foreign)
				if foreign.R == nil {
					foreign.R = &myFeedR{}
				}
				foreign.R.User = local
...
// AddUserArticleComments adds the given related objects to the existing relationships
// of the profile, optionally inserting them as new records.
// Appends related to o.R.UserArticleComments.
// Sets related.R.User appropriately.
func (o *Profile) AddUserArticleComments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ArticleComment) error {
	var err error
	...
	if o.R == nil {
		o.R = &profileR{
			UserArticleComments: related,
		}
	} else {
		o.R.UserArticleComments = append(o.R.UserArticleComments, related...)
	}

	for _, rel := range related {
		if rel.R == nil {
			rel.R = &articleCommentR{
				User: o,
			}
		} else {
			rel.R.User = o
...
// AddUserBookmarks adds the given related objects to the existing relationships
// of the profile, optionally inserting them as new records.
// Appends related to o.R.UserBookmarks.
// Sets related.R.User appropriately.
func (o *Profile) AddUserBookmarks(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Bookmark) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
	...
	if o.R == nil {
		o.R = &profileR{
			UserBookmarks: related,
		}
	} else {
		o.R.UserBookmarks = append(o.R.UserBookmarks, related...)
	}
...
// AddUserMyFeeds adds the given related objects to the existing relationships
// of the profile, optionally inserting them as new records.
// Appends related to o.R.UserMyFeeds.
// Sets related.R.User appropriately.
func (o *Profile) AddUserMyFeeds(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*MyFeed) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
	...
	if o.R == nil {
		...
		o.R.UserMyFeeds = append(o.R.UserMyFeeds, related...)
	}
...
func FindProfile(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Profile, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "entity: unable to select from profiles")
	}
...
func (o *Profile) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("entity: no profiles provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to insert into profiles")
	}
...
func (o *Profile) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("entity: unable to update profiles, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update profiles row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by update for profiles")
	}
...
func (q profileQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all for profiles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected for profiles")
	}
...
func (o ProfileSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to update all in profile slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to retrieve rows affected all in update all profile")
	}
	return rowsAff, nil
}
...
func (o *Profile) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("entity: no profiles provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("entity: unable to upsert profiles, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(profilePrimaryKeyColumns) == 0 {
				return errors.New("entity: unable to upsert profiles, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert profiles")
	}
...
func (o *Profile) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("entity: no Profile provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete from profiles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by delete for profiles")
	}
...
func (q profileQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("entity: no profileQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from profiles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "entity: failed to get rows affected by deleteall for profiles")
	}
...
func (o ProfileSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "entity: unable to delete all from profile slice")
	}
...
func (o *ProfileSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to reload all in ProfileSlice")
	}
...
func ProfileExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "entity: unable to check if profiles exists")
	}
