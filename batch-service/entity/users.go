...
type User struct {
	...
	EmailVerified null.Time   `boil:"email_verified" json:"email_verified,omitempty" toml:"email_verified" yaml:"email_verified,omitempty"`
	Image         null.String `boil:"image" json:"image,omitempty" toml:"image" yaml:"image,omitempty"`
	IsSuperAdmin  null.Bool   `boil:"is_super_admin" json:"is_super_admin,omitempty" toml:"is_super_admin" yaml:"is_super_admin,omitempty"`
...
var UserWhere = struct {
	...
	IsSuperAdmin  whereHelpernull_Bool
	...
	EmailVerified: whereHelpernull_Time{field: "\"users\".\"email_verified\""},
	Image:         whereHelpernull_String{field: "\"users\".\"image\""},
	IsSuperAdmin:  whereHelpernull_Bool{field: "\"users\".\"is_super_admin\""},
...
func (r *userR) GetAccounts() AccountSlice {
	if r == nil {
		return nil
	}
	return r.Accounts
...
var (
	userAllColumns            = []string{"id", "name", "email", "email_verified", "image", "is_super_admin", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"id", "updated_at"}
	userColumnsWithDefault    = []string{"name", "email", "email_verified", "image", "is_super_admin", "created_at", "deleted_at"}
...
func (o *User) Accounts(mods ...qm.QueryMod) accountQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"accounts\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadAccounts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`accounts`),
		qm.WhereIn(`accounts.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddAccounts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Account) error {
	var err error
