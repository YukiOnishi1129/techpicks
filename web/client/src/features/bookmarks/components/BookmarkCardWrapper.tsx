      ...
      const newFavoriteArticleFolder: FavoriteArticleFolderType = {
        ...
        favoriteArticles: [
          ...targetFavoriteArticleFolder.favoriteArticles,
          {
            ...
            publishedAt: showBookmark.publishedAt || null,
            authorName: null,
            tags: null,
            thumbnailURL: showBookmark.thumbnailURL || null,
            platformName: showBookmark.platformName || null,
            platformUrl: showBookmark.platformUrl || null,
            platformFaviconUrl: showBookmark.platformFaviconUrl || null,
