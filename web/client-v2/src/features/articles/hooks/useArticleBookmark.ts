...
export const UseArticleBookmarkFragment = graphql(`
...
export const useArticleBookmark = (
  data: FragmentOf<typeof UseArticleBookmarkFragment>
) => {
  const fragment = readFragment(UseArticleBookmarkFragment, data);
