...
export type TrendArticleDashboardTemplateQueryQuery = {
  __typename?: "Query";
  enArticles: {
    __typename?: "ArticleConnection";
    pageInfo: {
 ...
 * });
 */
export function useTrendArticleDashboardTemplateQueryQuery(
  baseOptions: Apollo.QueryHookOptions<
    TrendArticleDashboardTemplateQueryQuery,
    TrendArticleDashboardTemplateQueryQueryVariables
  > &
    (
      | {
          variables: TrendArticleDashboardTemplateQueryQueryVariables;
          skip?: boolean;
        }
      | { skip: boolean }
    )
  ...
  return Apollo.useQuery<
    TrendArticleDashboardTemplateQueryQuery,
    TrendArticleDashboardTemplateQueryQueryVariables
  >(TrendArticleDashboardTemplateQueryDocument, options);
}
export function useTrendArticleDashboardTemplateQueryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    TrendArticleDashboardTemplateQueryQuery,
    TrendArticleDashboardTemplateQueryQueryVariables
  >
...
export function useTrendArticleDashboardTemplateQuerySuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    TrendArticleDashboardTemplateQueryQuery,
    TrendArticleDashboardTemplateQueryQueryVariables
  >
...
export type TrendArticleDashboardTemplateQueryQueryHookResult = ReturnType<
  typeof useTrendArticleDashboardTemplateQueryQuery
>;
export type TrendArticleDashboardTemplateQueryLazyQueryHookResult = ReturnType<
  typeof useTrendArticleDashboardTemplateQueryLazyQuery
>;
export type TrendArticleDashboardTemplateQuerySuspenseQueryHookResult =
  ReturnType<typeof useTrendArticleDashboardTemplateQuerySuspenseQuery>;
export type TrendArticleDashboardTemplateQueryQueryResult = Apollo.QueryResult<
  TrendArticleDashboardTemplateQueryQuery,
  TrendArticleDashboardTemplateQueryQueryVariables
>;
